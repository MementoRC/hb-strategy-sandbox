...
class TestPerformanceCollector:
    ...
    def test_baseline_storage_and_loading(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            metrics.add_result(BenchmarkResult(
                name="test_benchmark",
                execution_time=0.1,
                memory_usage=50.0
            ))
    ...
    def test_baseline_comparison(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            baseline_metrics.add_result(BenchmarkResult(
                name="test_benchmark",
                execution_time=0.1,
                memory_usage=50.0,
                throughput=100.0
            ...
            current_metrics.add_result(BenchmarkResult(
                name="test_benchmark",
...
class TestPerformanceMetrics:
    ...
    def test_serialization_roundtrip(self):
        ...
        original_metrics.add_result(BenchmarkResult(
            name="test_benchmark",
            execution_time=0.1,
            memory_usage=50.0,
            metadata={"test": "value"}
