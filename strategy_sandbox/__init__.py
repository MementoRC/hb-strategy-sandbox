...
try:
    ...
    from framework.maintenance import (
        CIHealthMonitor,
    ...
    __all__.extend([
        # Performance tools
        "PerformanceCollector", "PerformanceComparator", "PerformanceMetrics",
        "BenchmarkResult", "AlertSeverity", "ComparisonMode", "PerformanceAlert",
        "TrendAnalyzer", "TrendAlert", "TrendData", "schema",
        # Security tools
        "DependencyAnalyzer", "SecurityCollector", "SBOMGenerator",
        "DependencyInfo", "SecurityMetrics", "VulnerabilityInfo",
        # Reporting tools
        "ReportGenerator", "ArtifactManager", "TemplateEngine", "GitHubReporter",
        # Maintenance tools
        "CIHealthMonitor", "MaintenanceScheduler"
    ])
