...
class ExchangeSimulator:
    ...
    async def _fill_order(self, order: Order) -> None:
        ...
        # Emit events
        self._event_system.emit_event(MarketEvent.ORDER_FILLED, {
    ...
    def place_order(self, order_candidate: OrderCandidate) -> str:
        ...
        # Emit event
        self._event_system.emit_event(MarketEvent.ORDER_CREATED, {
            "order_id": order_id,
            "trading_pair": order_candidate.trading_pair,
    ...
    def cancel_order(self, order_id: str) -> bool:
        ...
        # Emit event
        self._event_system.emit_event(MarketEvent.ORDER_CANCELLED, {
            "order_id": order_id,
            "timestamp": self._current_timestamp,
        })
    ...
    def get_open_orders(self, trading_pair: Optional[str] = None) -> List[Order]:
        ...
        orders = [order for order in self._active_orders.values() 
                 if order.status == OrderStatus.OPEN]
